...
*/
let castIntToFloat = Float(myAgeInTenYears)
let castDoubleToFloat = Float(daysInYear)
var daysPassed:Float = (castIntToFloat * castDoubleToFloat)
/*
Exercise 2.5
...
print("Hypotenuse is \(ab), Area is \(area), Perimeter is \(perimeter)")
